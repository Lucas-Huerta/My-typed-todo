		...
		<div className="container mx-auto p-4">
			...
			<div className="mb-6">
				...
				<select
					...
					onChange={(e) =>
						setNewTask({ ...newTask, status: e.target.value as TodoStatus })
					}
					className="border p-2 rounded mb-2 w-full"
				>
				...
				<select
					...
					onChange={(e) =>
						setNewTask({ ...newTask, priority: e.target.value as Todopriority })
					}
					className="border p-2 rounded mb-2 w-full"
				>
				...
				<input
					type="date"
					value={`${newTask.duDate.year}-${padZero(
						newTask.duDate.month
					)}-${padZero(newTask.duDate.day)}`}
					onChange={(e) => {
								...
								>
									<div className="flex flex-wrap text-left justify-between">
										...
										<span className="text-gray-600">
											{padZero(task.duDate.day)}/{padZero(task.duDate.month)}/
											{task.duDate.year}
										</span>
										<span className="text-gray-600">
